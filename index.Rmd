...
personas <- c("Lorena", "Beatriz", "Carla", "Nelson","Ana")
...
```{r, eval=FALSE}
compClase <- c("JUAN","PABLO","EDWART","JOSHEP","JOEL","ISSAC", "JESUS", "SAID", "ROBERTO", "Emiliano")
print(compClase)
```
...
seq(0,log(8,base=exp(2)), length=20)
...
grid(col="#72efde")      # Le agregamos lineas punteadas con color.
```
